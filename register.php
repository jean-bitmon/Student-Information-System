<?php 
  ...
  if(isset($_POST['register'])) {
    ...
    $query = "SELECT username FROM parent WHERE username = '$uname'";
    $result = mysqli_query($con,$query);

    if(mysqli_num_rows($result) == 0) {

      $query = "SELECT studentno FROM parent WHERE studentno = '$studno'";
      $result = mysqli_query($con,$query);

      if(mysqli_num_rows($result) == 0) {

        $query = "INSERT INTO parent (username, password, studentno, firstname, lastname, course, yrlevel, date_joined)
        ...
        <div class="row">
          ...
          <div class="personal-info col-sm-6">
            ...
            <fieldset>
              ...
              <div class="form-group">
                <label for="yrlevel">Student Year Level</label>
